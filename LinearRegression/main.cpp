...
// The linear regression formula is y = a + bx + E
// Where:
// a, b is dispersion mean-square deviation
// x is average Target value
// E is probability
...
float regression_model(float Features[], float target[]){
    ...
    // here we count all the mean/sum/square of Features and target
    ...
    // here we multiply every X[i] and y[i]
    float XY[8];
    ...
    // take the dispersion mean-square deviation coefficients
